        ...
        <template x-teleport="body">
            <div x-show="itemModalOpen" x-cloak class="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-0">
                ...
                <div x-show="itemModalOpen" 
                     ...
                     class="relative bg-white rounded-2xl shadow-xl w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto m-auto">
                    ...
                    <form @submit.prevent="saveItem()" class="space-y-4">
                        ...
                        <div class="flex items-center gap-3 pt-4 border-t border-slate-100 mt-6">
                            <button type="button" @click="itemModalOpen = false" class="flex-1 px-4 py-2.5 text-sm font-semibold text-slate-600 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors">Batal</button>
                            <button type="submit" class="flex-1 px-4 py-2.5 text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 rounded-xl transition-colors shadow-sm">
    ...
    <template x-teleport="body">
        <div x-show="cancelModalOpen" x-cloak class="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-0">
            ...
            <div x-show="cancelModalOpen" 
                ...
                <p class="text-sm text-slate-500 mb-6">Anda memiliki perubahan pada daftar item yang belum disimpan. Yakin ingin membuang perubahan ini dan kembali?</p>
